...
import pageData from "./about-fadeout.json";
    ...
    if (isOpen) {
      const fetchContent = async () => {
        try {
          ...
          const response = await fetch(`${baseUrl}/api/static-page/detail/about-fadeout`);
          if (response.ok) {
          ...
          console.error("Failed to fetch About FadeOut content:", error);
        }
      };
      fetchContent();
    }
